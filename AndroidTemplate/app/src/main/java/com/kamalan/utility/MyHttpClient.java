...
public class MyHttpClient {
    ...
    public static String getServerResponseByHttpGet(String url, String token) {
        ...
        try {
            ...
            HttpContext localContext = createCookie(token);
     ...
     * @return server response
     */
    public static String getServerResponseByHttpPost(String url, String token) {
     ...
     * @return server response
     */
    public static String getServerResponseByHttpPost(String url, String token, List<NameValuePair> pairs) {
        ...
        try {
            ...
            int connectionStatusCode = httpResponse.getStatusLine().getStatusCode();
            Log.d(TAG, "Connection code: " + connectionStatusCode + " for request: " + url);
//            Log.d(TAG, "res_header: " + Arrays.toString(httpResponse.getAllHeaders()));
     ...
     * @return server response
     */
    public static String getServerResponseByHttpPut(String url, String token, List<NameValuePair> pairs) {
     ...
     * @return server response
     */
    public static String getServerResponseByHttpDelete(String url, String token) {
    ...
    private static HttpContext createCookie(String token) {
        CookieStore cookieStore = new BasicCookieStore();
        Cookie cookie = new BasicClientCookie("PHPSESSID", token);
